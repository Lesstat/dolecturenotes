...
- Figure 1 Primal Simplex
- Figure 2
- V-Shape: corener defined by d lin. indep. constrinats which have
...
- If $x_0$ violates some constriant $h_i \not\in B$, that is,
  ...
  $B\cup\{h_i\}$. Naively this can be done by considering the $n+1
  \choose n = n$ subsets of $B\cup\{h_i\}$ of cardinality n, computing
  their intersection point and checking feasibility.
- Figure 8
